...
class DriverHeadingToFaculty extends StatefulWidget {
  const DriverHeadingToFaculty({Key? key}) : super(key: key);

  @override
  State<DriverHeadingToFaculty> createState() => _DriverHeadingToFacultyState();
}

class _DriverHeadingToFacultyState extends State<DriverHeadingToFaculty> {
  ...
  Future<void> saveRideDetailsToFirestore() async {
    try {
      ...
      DocumentReference rideReference = await
      FirebaseFirestore.instance.collection('Drivers').
      doc(userId).collection('HeadingToFaculty').add({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Add Ride Details"),
        centerTitle: true,
        ...
        Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text("Heading to Faculty:", style: TextStyle(fontSize: 20, ),),
            ),
